...
for index, value in enumerate(s):
	if value.islower():
		if s_copy[index-3:index].isupper() == True and s_copy[index+1:index+4].isupper() == True and s_copy[index-4].islower == True and s_copy[index+4].islowerr == True:
			print s_copy[index-3:index+4]
			
	

  File "<pyshell#2>", line 3, in <module>
    if s[index-3,index].isupper() == True and s[index+1,index+4].isupper() == True:
